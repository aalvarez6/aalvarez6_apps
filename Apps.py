...
# ============================================================================
#  LISTA DE APLICACIONES (edita aquí fácilmente)
# ============================================================================
APPS = [
    {
...
# ============================================================================
#  CSS ESTILO macOS OSCURO (tarjetas redondeadas, fondo negro)
# ============================================================================
st.markdown("""
<style>
    html, body, [class*="css"] {
...
# ============================================================================
#  LOGO ANIMADO (OSO ARTEMIS HUB + PARTÍCULAS)
# ============================================================================
...
with st.sidebar:
    ...
    st.write(
        "La IA permite mejorar la toma de decisiones con datos, "
        "automatizar tareas y proporcionar análisis avanzados en tiempo real."
    )
    st.markdown("---")
    st.markdown("### 🔗 Recursos")
    st.markdown("[Páginas y ejercicios prácticos](https://sites.google.com/view/aplicacionesdeia/inicio)")
    st.markdown("---")
    st.caption("Artemis Hub · v3.0")

# ============================================================================
#  GRID DE APLICACIONES (4 columnas)
# ============================================================================
st.markdown("""
...
for idx, app in enumerate(APPS):
    with cols[idx % 4]:
        # Intentar cargar imagen local o URL
        try:
...
#  FOOTER
# ============================================================================
st.markdown('<div class="footer">🍎 Diseño Artemis Hub • Tarjetas uniformes • Todas las apps funcionando</div>', unsafe_allow_html=True)
